...
public final class MethodUtil extends SecureClassLoader {
    ...
    // tsbMobile: hier stand 'private static final Method bounce = getTrampoline();'.
    // Der statische Initialisierer baute das Trampolin, noch bevor irgendjemand invoke
    // rief — deshalb warf die Klasse weiter, obwohl invoke schon ersetzt war. Ein halber
    // Flicken ist keiner.
     ...
     */
    /**
     * tsbMobile: ruft die Methode unmittelbar auf.
     *
     * <p>Hier stand ein Aufruf ueber {@code bounce} — ein "Trampolin": MethodUtil laedt eine
     * Hilfsklasse {@code sun.reflect.misc.Trampoline} aus den eigenen Bytes ueber einen
     * eigenen Klassenlader, damit der Aufruf ohne die Rechte des Aufrufers stattfindet. Das
     * ist Applet-Sandkasten aus den neunziger Jahren.
     *
     * <p>Auf dem Telefon scheitert das Laden — {@code InternalError: bouncer cannot be found},
     * im statischen Initialisierer, ausgeloest von {@code UIDefaults.getUI}. Und es hat dort
     * auch keinen Zweck: es gibt keinen Sicherheitsverwalter und keinen fremden Code, vor dem
     * ein Trampolin schuetzen wuerde. Eine App ist ein signiertes Buendel aus einer Quelle.
     */
