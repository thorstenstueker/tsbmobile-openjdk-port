...
public class SwingUtilities2 {
    ...
    public static int getLeftSideBearing(JComponent c, FontMetrics fm,
        ...
        // nichts: die Fabrik sucht sun.awt.X11FontManager und findet ihn nicht.
        //
        // Fuer diese Korrektur eine Schriftmaschine mitzuschleppen waere ein schlechter
        // Handel. Null heisst: die Beschriftung sitzt an ihrem Kaestchen statt an ihrer
        // Kontur. Auf einem Telefon ist das unsichtbar; das Alternativangebot ist eine
        // Maske, die gar nicht erscheint.
        return 0;
    }
    ...
    public static FontMetrics getFontMetrics(JComponent c, Font font) {
        // tsbMobile: hier stand 'return FontDesignMetrics.getMetrics(font, frc)'.
        //
        // Das ist der Eingang zu sun.font — FontDesignMetrics → SunFontManager →
        // StrikeCache → FreeType. Diese Kette haelt auf beiden Telefonen an: auf iOS fehlt
        // die native Methode StrikeCache.getGlyphCacheDescription, auf Android verwehrt die
        // Laufzeit Unsafe.getUnsafe() allem, was nicht vom Bootclasspath kommt.
        //
        // Sie zu reparieren waere falsch. Android misst Text mit Skia, iOS mit CoreText,
        // und beide koennen es besser als ein nachgebauter Glyphen-Cache. Deshalb wird hier
        // abgeschnitten statt geflickt: tsb.port.Schrift fragt die Plattform.
        //
        // Der FontRenderContext faellt damit weg. Er beschreibt Kantenglaettung und
        // Bildpunktdichte fuer die Rasterung — Entscheidungen, die jetzt die Plattform
        // trifft, nicht Java.
