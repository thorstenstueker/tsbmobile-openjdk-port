...
public final class SwingAccessor {
     ...
     *
     * <p>Dieselbe Reparatur wie in {@code sun.awt.AWTAccessor}, dritter Fall derselben
     * Familie. Zwei Gruende: MobiVMs Unsafe kennt {@code ensureClassInitialized} nicht, und
     * Android erlaubt {@code Unsafe.getUnsafe()} ueberhaupt nur Klassen vom Bootclasspath —
     * sonst {@code SecurityException}, im statischen Initialisierer, womit
     * {@code RepaintManager} gleich mit unterging.
     */
    ...
    public static JTextComponentAccessor getJTextComponentAccessor() {
        if (jtextComponentAccessor == null) {
            initialisiere(JTextComponent.class);
        }
    ...
    public static JLightweightFrameAccessor getJLightweightFrameAccessor() {
        if (jLightweightFrameAccessor == null) {
            initialisiere(JLightweightFrame.class);
        }
    ...
    public static RepaintManagerAccessor getRepaintManagerAccessor() {
        if (repaintManagerAccessor == null) {
            initialisiere(RepaintManager.class);
        }
