            ...
            new PrivilegedAction<Boolean>() {
                public Boolean run() {
                    ...
                    if (arch == null || !arch.startsWith("sparc")) {
                        try {
                            /* tsbMobile: hier stand System.loadLibrary(...). Auf dem Telefon gibt es kein
               libawt, libfontmanager oder liblcms — die Rueckseite ist Skia.
               Zehn solcher Stellen hat der Port; sie wurden auf einmal gezaehlt,
               nachdem die dritte einzeln aufgetaucht war. */
