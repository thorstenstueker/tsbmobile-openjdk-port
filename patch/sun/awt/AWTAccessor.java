...
public final class AWTAccessor {
    ...
    // tsbMobile: hier stand 'private static final Unsafe unsafe = Unsafe.getUnsafe();'.
    // Benutzt wurde es nur fuer ensureClassInitialized, und das ist ersetzt. Stehen
    // lassen konnte man es trotzdem nicht: Android erlaubt Unsafe.getUnsafe() nur
    // Klassen vom Bootclasspath und wirft sonst SecurityException — im statischen
    // Initialisierer, womit Toolkit gleich mit unterging.

    /**
     * tsbMobile: Ersatz fuer {@code unsafe.ensureClassInitialized(c)}.
     *
     * <p>MobiVMs {@code sun.misc.Unsafe} stammt aus Androids libcore und hat diese Methode
     * nicht — {@code NoSuchMethodError} beim ersten Zugriff auf einen Accessor, ausgeloest
     * von {@code UIManager.initialize}. Dieselbe Familie wie {@code SharedSecrets}.
     *
     * <p>{@code Class.forName} mit {@code initialize=true} tut genau dasselbe: es stellt
     * sicher, dass der statische Initialisierer gelaufen ist. Nur ohne Unsafe.
     */
    private static void initialisiere(Class<?> c) {
        try {
            Class.forName(c.getName(), true, c.getClassLoader());
        } catch (ClassNotFoundException unmoeglich) {
            throw new InternalError("tsbMobile: " + c.getName() + " ist da, aber nicht da",
                    unmoeglich);
        }
    }
    ...
    public static InputEventAccessor getInputEventAccessor() {
        if (inputEventAccessor == null) {
            initialisiere(InputEvent.class);
        }
    ...
    public static MouseEventAccessor getMouseEventAccessor() {
        if (mouseEventAccessor == null) {
            initialisiere(MouseEvent.class);
        }
    ...
    public static KeyboardFocusManagerAccessor getKeyboardFocusManagerAccessor() {
        if (kfmAccessor == null) {
            initialisiere(KeyboardFocusManager.class);
        }
        return kfmAccessor;
    }
    ...
    public static MenuComponentAccessor getMenuComponentAccessor() {
        if (menuComponentAccessor == null) {
            initialisiere(MenuComponent.class);
        }
    ...
    public static EventQueueAccessor getEventQueueAccessor() {
        if (eventQueueAccessor == null) {
            initialisiere(EventQueue.class);
        }
    ...
    public static FileDialogAccessor getFileDialogAccessor() {
        if (fileDialogAccessor == null) {
            initialisiere(FileDialog.class);
        }
    ...
    public static ScrollPaneAdjustableAccessor getScrollPaneAdjustableAccessor() {
        if (scrollPaneAdjustableAccessor == null) {
            initialisiere(ScrollPaneAdjustable.class);
        }
    ...
    public static CheckboxMenuItemAccessor getCheckboxMenuItemAccessor() {
        if (checkboxMenuItemAccessor == null) {
            initialisiere(CheckboxMenuItemAccessor.class);
        }
    ...
    public static CursorAccessor getCursorAccessor() {
        if (cursorAccessor == null) {
            initialisiere(CursorAccessor.class);
        }
    ...
    public static MenuBarAccessor getMenuBarAccessor() {
        if (menuBarAccessor == null) {
            initialisiere(MenuBarAccessor.class);
        }
    ...
    public static MenuItemAccessor getMenuItemAccessor() {
        if (menuItemAccessor == null) {
            initialisiere(MenuItemAccessor.class);
        }
    ...
    public static MenuAccessor getMenuAccessor() {
        if (menuAccessor == null) {
            initialisiere(MenuAccessor.class);
        }
        return menuAccessor;
    }
    ...
    public static KeyEventAccessor getKeyEventAccessor() {
        if (keyEventAccessor == null) {
            initialisiere(KeyEventAccessor.class);
        }
    ...
    public static ClientPropertyKeyAccessor getClientPropertyKeyAccessor() {
        if (clientPropertyKeyAccessor == null) {
            initialisiere(ClientPropertyKeyAccessor.class);
        }
    ...
    public static SystemTrayAccessor getSystemTrayAccessor() {
        if (systemTrayAccessor == null) {
            initialisiere(SystemTrayAccessor.class);
        }
    ...
    public static TrayIconAccessor getTrayIconAccessor() {
        if (trayIconAccessor == null) {
            initialisiere(TrayIconAccessor.class);
        }
    ...
    public static DefaultKeyboardFocusManagerAccessor getDefaultKeyboardFocusManagerAccessor() {
        if (defaultKeyboardFocusManagerAccessor == null) {
            initialisiere(DefaultKeyboardFocusManagerAccessor.class);
        }
    ...
    public static SystemColorAccessor getSystemColorAccessor() {
        if (systemColorAccessor == null) {
            initialisiere(SystemColor.class);
        }
    ...
    public static AccessibleContextAccessor getAccessibleContextAccessor() {
        if (accessibleContextAccessor == null) {
            initialisiere(AccessibleContext.class);
        }
