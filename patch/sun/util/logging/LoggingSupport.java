        ...
        AccessController.doPrivileged(new PrivilegedAction<LoggingProxy>() {
            public LoggingProxy run() {
                try {
                    ...
                    // tsbMobile: hier stand 'throw new AssertionError(e)'. Android hat die
                    // Klasse java.util.logging.LoggingProxyImpl sehr wohl, aber ohne das
                    // Feld INSTANCE — eine andere Bauart derselben Idee. Kein Grund, den
                    // Start abzubrechen: ohne Proxy protokolliert PlatformLogger eben
                    // nicht, und das ist auf einem Telefon die richtige Menge Protokoll.
                    return null;
