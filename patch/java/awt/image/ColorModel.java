...
public abstract class ColorModel implements Transparency{
        ...
        if (!loaded) {
            java.security.AccessController.doPrivileged(
                new java.security.PrivilegedAction<Void>() {
                    public Void run() {
                        // tsbMobile: war System.loadLibrary("awt"). Die Quelle von
                        // Toolkit.loadLibraries warnt ausdruecklich vor genau dieser
                        // zweiten Stelle — Klassen in java.awt.image koennen geladen
                        // werden, ohne dass Toolkit je angefasst wurde.
                        return null;
                    }
                });
            loaded = true;
    ...
    // tsbMobile: war nativ. Siehe Toolkit.initIDs — ohne libawt nichts zu registrieren.
