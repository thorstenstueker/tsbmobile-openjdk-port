...
public abstract class Toolkit {
     ...
     */
    // tsbMobile: war 'private static native void initIDs()'. Registriert JNI-Feld-
    // kennungen fuer libawt. Ohne libawt gibt es nichts zu registrieren.
    ...
    static void loadLibraries() {
        if (!loaded) {
            java.security.AccessController.doPrivileged(
                new java.security.PrivilegedAction<Void>() {
                    public Void run() {
                        // tsbMobile: war System.loadLibrary("awt"). Auf dem Telefon
                        // gibt es kein libawt; die Rueckseite ist Skia.
                        return null;
                    }
                });
            loaded = true;
