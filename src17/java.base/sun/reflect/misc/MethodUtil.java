...
public final class MethodUtil extends SecureClassLoader {
    ...
    // Das Trampolin laedt eine Hilfsklasse ueber einen eigenen Klassenlader, damit ein
    // Aufruf ohne die Rechte des Aufrufers stattfindet — Applet-Sandkasten. Auf dem Telefon
    // scheitert das Laden im statischen Initialisierer (InternalError: bouncer cannot be
    // found), ausgeloest von UIDefaults.getUI, und es hat dort keinen Zweck.
    ...
    public static Object invoke(Method m, Object obj, Object[] params)
        throws InvocationTargetException, IllegalAccessException {
        // tsbMobile: unmittelbar, ohne Trampolin.
        return m.invoke(obj, params);
    }
